...
export const Orbit = ({baseimg, knowns, topmargin, leftmargin, size, know, margintext}) =>{
    console.log('existo y tengo estos knowns', knowns)
    console.log(`../icons/Knowledge/${knowns[0].name}`)
    return(
        <div style={{width: `${size}vw`,height: `${size}vw`, marginTop:`${topmargin}%`, marginLeft: `${leftmargin}%`}} className="giro">
            ...
            {
             knowns?.map((known) =>
             <div className="Aux" style={{borderRadius: '50%',border: '1px dashed white',width: `${known.distance * 2}vw` ,height: `${known.distance * 2}vw`}}>
